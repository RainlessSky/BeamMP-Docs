...
=== Help! My BeamMP launcher doesn't work!
    ...
    !!! note
        As of April 5th, 2026, Microsoft Edge warns that `BeamMP_Installer.msi` from [beammp.com](https://beammp.com/) is unsafe.

        To bypass this warning, hover over the file, click *More actions*, click *Keep*, then click *Keep anyway*.
    !!! note

        As of April 5th, 2026, the MSI installer is an "unrecognized app" according to Windows Defender SmartScreen.
        
        To bypass this warning, click *More info*, then click *Run anyway*.
=== Help! My authkey(s) don't work anymore!
    As of April 5th, 2026, keymaster and auth systems are offline. This means that your authkeys won't work. To get around this, follow the instructions below:
    ...
    !!! note
        As of April 5th, 2026, BeamMP's auth systems are offline. Only guest accounts are available.
